...
if [[ -z $CONFLUENT_HOME ]]; then
    ...
    /usr/local/confluent-5.2.1/bin/connect-standalone /usr/local/confluent-5.2.1/etc/schema-registry/connect-avro-standalone.properties config/MySourceConnectorExample.properties
else
