...
public class DataConverter {
    ...
    public DataConverter(ArrayEncoding arrayEncoding) {
    ...
    public void setFieldSchema(Map.Entry<String, BsonValue> keyValuesforSchema, SchemaBuilder builder){
        ...
        switch (type) {
            ...
            case JAVASCRIPT_WITH_SCOPE:
                ...
                for (Map.Entry<String, BsonValue> jwsDocumentKey : jwsDocument.entrySet()) {
                    setFieldSchema(jwsDocumentKey, scope);
                }
                ...
                if (keyValuesforSchema.getValue().asArray().isEmpty()) {
                    ...
                    switch (arrayEncoding) {
                                ...
                                case DOCUMENT:
                                    ...
                                    for (BsonValue element: keyValuesforSchema.getValue().asArray()) {
                                        ...
                                        for (Map.Entry<String, BsonValue> arrayDoc: arrayDocs.entrySet()) {
                                            ...
                                            if (prevType == null) {
                                                setFieldSchema(arrayDoc, documentSchemaBuilder);
                                            }
                        ...
                        case DOCUMENT:
                            ...
                            convertedArray.entrySet().forEach(x -> setFieldSchema(x, arrayStructBuilder));
    ...
    public void convertFieldValue(Map.Entry<String, BsonValue> keyvalueforStruct, Struct struct, Schema schema) {
        ...
        switch (type) {
            ...
            case JAVASCRIPT_WITH_SCOPE:
                ...
                for (Map.Entry<String, BsonValue> jwsDocKey : jwsDoc.entrySet()) {
                        ...
                        case ARRAY:
                            ...
                            arrValues.stream().forEach(arrValue -> {
                                if (arrValue.getBsonType() == BsonType.STRING && valueType == BsonType.STRING) {
                                    ...
                                    for (Map.Entry<String, BsonValue> entry9 : arrValue.asDocument().entrySet()) {
    ...
    public void setSchema(Set<Map.Entry<String, BsonValue>> keyValuePairs, SchemaBuilder builder) {
        for (Map.Entry<String, BsonValue> recordKeyValue : keyValuePairs) {
            setFieldSchema(recordKeyValue, builder);
        }
    }


    public void setStruct(Set<Map.Entry<String, BsonValue>> keyValuePairs, Struct struct, Schema schema) {
        for (Map.Entry<String, BsonValue> recordKeyValue : keyValuePairs) {
            convertFieldValue(recordKeyValue, struct, schema);
        }
    }
}